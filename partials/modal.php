<input class="modal-btn" type="checkbox" id="modal-btn" name="modal-btn" onclick="NewPost()" />
<label for="modal-btn">
    <svg class="postbtn" color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 48 48" width="24">
...
<div class="modal">
    <div class="modal-wrap">
        <div class="title-box">
            ...
            <button id="share-button" class="next-upload">Đăng</button>
        </div>
        <div class="content-box">
            <svg aria-label="Biểu tượng thể hiện file phương tiện, chẳng hạn như hình ảnh hoặc video" color="#262626" fill="#262626" height="77" role="img" viewBox="0 0 97.6 77.3" width="96">
            ...
            <input type="file" name="file" id="file" class="inputfile" onchange="checkFileDetails(this);" />
            <label for="file">Chọn từ máy tính</label>
        </div>
        <div class="contet-show-img-upload" style="display: none;">
            <div class="image-post">
                <img id="blah" src="#" alt="your image" />
            </div>
            <div class="status">
                <textarea name="status" placeholder="Viết chú thích... " cols="40" rows="4"></textarea>
            </div>
        </div>
    </div>
</div>
