    ...
    <div class="modal-wrap">
        <form method="post" action="post.php" enctype="multipart/form-data">
            <div class="title-box">
                ...
                <button id="share-button" class="next-upload" type="submit">Đăng</button>
            </div>
            <div class="content-box">
                ...
                <input type="file" name="image" id="file" class="inputfile" onchange="checkFileDetails(this);" />
                <label for="file">Chọn từ máy tính</label>
            </div>
            <div class="contet-show-img-upload" style="display: none;">
                <div class="image-post">
                    <img id="blah" name="image" src="#" alt="your image" />
                </div>
                <div class="status">
                    <textarea name="content" placeholder="Viết chú thích... " cols="40" rows="4" required></textarea>
                </div>
            </div>
        </form>
    </div>
