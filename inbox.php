...
<head>
    ...
    <script src="./JS/click_on_mess.js" defer></script>
</head>
            ...
            <div class="nickname-list-friend">
                <div class="nickname">
                    ...
                    <button>
                        <div class="user">
                            ...
                            <span>
                                <svg color="#262626" fill="#262626" height="20" role="img" viewBox="0 0 48 48"
                                    width="20">
                                    <path
                ...
                <div class="list-friend">
                    <div class="side-menu__chat-content">
                        <a href="#" id="0" class="side-menu__chat" onClick="friendSelect()">
                            <div class="side-menu__chat-avatar">
                                <img src="./images/images user/user0.jpg" alt="User Picture">
                            </div>
                            <div class="side-menu__chat-info">
                                <h5>Adelaide</h5>
                                <div class="all-content">
                                    <span id="text0" class="content-text"></span>
                                    <span class="time">.</span>
                                    <span class="time">1 giờ</span>
                                </div>
                            </div>
                        </a>
                        <a href="#" id="1" class="side-menu__chat" onClick="friendSelect()">
                            <div class="side-menu__chat-avatar">
                                <img src="./images/images user/user1.jpg" alt="User Picture">
                            </div>
                            <div class="side-menu__chat-info">
                                <h5>Alice</h5>
                                <div class="all-content">
                                    <span id="text1" class="content-text"></span>
                                    <span class="time">.</span>
                                    <span class="time">1 giờ</span>
                                </div>
                            </div>
                        </a>
                        <a href="#" id="2" class="side-menu__chat" onClick="friendSelect()">
                            <div class="side-menu__chat-avatar">
                                <img src="./images/images user/user2.jpg" alt="User Picture">
                            </div>
                            <div class="side-menu__chat-info">
                                <h5>Amelinda</h5>
                                <div class="all-content">
                                    <span id="text2" class="content-text"></span>
                                    <span class="time">.</span>
                                    <span class="time">2 giờ</span>
                                </div>
                            </div>
                        </a>
                        <a href="#" id="3" class="side-menu__chat" onClick="friendSelect()">
                            <div class="side-menu__chat-avatar">
                                <img src="./images/images user/user3.jpg" alt="User Picture">
                            </div>
                            <div class="side-menu__chat-info">
                                <h5>Amanda</h5>
                                <div class="all-content">
                                    <span id="text3" class="content-text"></span>
                                    <span class="time">.</span>
                                    <span class="time">2 giờ</span>
                                </div>
                            </div>
                        </a>
                        <a href="#" id="4" class="side-menu__chat" onClick="friendSelect()">
                            <div class="side-menu__chat-avatar">
                                <img src="./images/images user/user4.jpg" alt="User Picture">
                            </div>
                            <div class="side-menu__chat-info">
                                <h5>Annabella</h5>
                                <div class="all-content">
                                    <span id="text4" class="content-text"></span>
                                    <span class="time">.</span>
                                    <span class="time">4 giờ</span>
                                </div>
                            </div>
                        </a>
                        <a href="#" id="5" class="side-menu__chat" onClick="friendSelect()">
                            <div class="side-menu__chat-avatar">
                                <img src="./images/images user/user5.jpg" alt="User Picture">
                            </div>
                            <div class="side-menu__chat-info">
                                <h5>Aurelia</h5>
                                <div class="all-content">
                                    <span id="text5" class="content-text"></span>
                                    <span class="time">.</span>
                                    <span class="time">2 giờ</span>
                                </div>
                            </div>
                        </a>
                        <a href="#" id="6" class="side-menu__chat" onClick="friendSelect()">
                            <div class="side-menu__chat-avatar">
                                <img src="./images/images user/user6.jpg" alt="User Picture">
                            </div>
                            <div class="side-menu__chat-info">
                                <h5>Brenna</h5>
                                <div class="all-content">
                                    <span id="text6" class="content-text"></span>
                                    <span class="time">.</span>
                                    <span class="time">3 giờ</span>
                                </div>
                            </div>
                        </a>
                        <a href="#" id="7" class="side-menu__chat" onClick="friendSelect()">
                            <div class="side-menu__chat-avatar">
                                <img src="./images/images user/user7.jpg" alt="User Picture">
                            </div>
                            <div class="side-menu__chat-info">
                                <h5>Fidelma</h5>
                                <div class="all-content">
                                    <span id="text7" class="content-text"></span>
                                    <span class="time">.</span>
                                    <span class="time">4 giờ</span>
                                </div>
                            </div>
                        </a>
                        <a href="#" id="8" class="side-menu__chat" onClick="friendSelect()">
                            <div class="side-menu__chat-avatar">
                                <img src="./images/images user/user8.jpg" alt="User Picture">
                            </div>
                            <div class="side-menu__chat-info">
                                <h5>Fiona</h5>
                                <div class="all-content">
                                    <span id="text8" class="content-text"></span>
                                    <span class="time">.</span>
                                    <span class="time">6 giờ</span>
                                </div>
                            </div>
                        </a>
                        <a href="#" id="9" class="side-menu__chat" onClick="friendSelect()">
                            <div class="side-menu__chat-avatar">
                                <img src="./images/images user/user9.jpg" alt="User Picture">
                            </div>
                            <div class="side-menu__chat-info">
                                <h5>Kaylin</h5>
                                <div class="all-content">
                                    <span id="text9" class="content-text"></span>
                                    <span class="time">.</span>
                                    <span class="time">2 giờ</span>
                                </div>
                            </div>
                        </a>
                        <a href="#" id="10" class="side-menu__chat" onClick="friendSelect()">
                            <div class="side-menu__chat-avatar">
                                <img src="./images/images user/user10.jpg" alt="User Picture">
                            </div>
                            <div class="side-menu__chat-info">
                                <h5>Sarah</h5>
                                <div class="all-content">
                                    <span id="text10" class="content-text"></span>
                                    <span class="time">.</span>
                                    <span class="time">2 giờ</span>
                                </div>
                            </div>
            ...
            <div class="box-chat-friend-select">
                <div class="name-friend">
                    <div class="avatar-and-name-user">
                        <a href="#"><img src="assets/default-user.png" alt="User Picture"></a>
                        <a href="#">
                            <h5></h5>
                        </a>
                    </div>
                ...
                <div class="input-mess">
                    <div class="input">
                        ...
                        <input id="type-mess" type="text " name="test" onkeyup="success()" placeholder="Nhắn tin... ">
                        <div class="right-button-input ">
                            ...
                            <button id="like-button">
                                <div class="new-mess ">
                                    <svg color="#262626 " fill="#262626 " height="24 " role="img " viewBox="0 0 24 24 "
                                        width="24 ">
                                        <path
                                            d="M16.792 3.904A4.989 4.989 0 0121.5 9.122c0 3.072-2.652 4.959-5.197 7.222-2.512 2.243-3.865 3.469-4.303 3.752-.477-.309-2.143-1.823-4.303-3.752C5.141 14.072 2.5 12.167 2.5 9.122a4.989 4.989 0 014.708-5.218
                            ...
                            <button id="send-button" class="send-btn" onClick="SendMess()">
                                <div class="new-mess ">
                                    <h2>Gửi</h2>
                                </div>
                            </button>
